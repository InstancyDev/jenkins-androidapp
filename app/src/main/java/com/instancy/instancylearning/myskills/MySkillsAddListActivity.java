...
import com.instancy.instancylearning.discussionfourmsenached.DiscussionModeratorAdapter;
import com.instancy.instancylearning.discussionfourmsenached.DiscussionModeratorModel;
...
public class MySkillsAddListActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {

    Context context = this;
    SVProgressHUD svProgressHUD;
    String TAG = MySkillsAddListActivity.class.getSimpleName();
    ...
    private String getLocalizationValue(String key){
        return  JsonLocalization.getInstance().getStringForKey(key,MySkillsAddListActivity.this);
    }
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<font color='" + uiSettingsModel.getHeaderTextColor() + "'>" +
                getLocalizationValue(JsonLocalekeys.mycompetency_label_skillheaderlabel)+ "</font>"));
        addSkillModelList = new ArrayList<AddSkillModel>();
        addSkillModelList = (List<AddSkillModel>) getIntent().getSerializableExtra("addSkillFilteredList");
        discussionFourmlistView = (ListView) findViewById(R.id.discussionfourmlist);
        addSkillAdapter = new AddSkillAdapter(this, BIND_ABOVE_CLIENT, addSkillModelList);
        discussionFourmlistView.setAdapter(addSkillAdapter);
    ...
    public void closeForum(int position) {
        ...
        if (position != -1) {
            ...
            intent.putExtra("addskilllmodel", addSkillModelList.get(position));
        } else {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.addskillsearch, menu);
...
//            searchClose.setImageResource(R.drawable.ic_filter_list_black_24dp);
            ...
            searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextChange(String newText) {
                    ...
                    addSkillAdapter.filter(newText.toLowerCase(Locale.getDefault()));
