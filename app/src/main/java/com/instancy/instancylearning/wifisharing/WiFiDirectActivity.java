...
public class WiFiDirectActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, WifiP2pManager.ChannelListener, DeviceListFragment.DeviceActionListener {


    public String TAG = WiFiDirectActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wifishareactivity);
