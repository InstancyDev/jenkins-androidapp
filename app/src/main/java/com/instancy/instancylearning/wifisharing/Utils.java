...
//    Calligrapher calligrapher;
    ...
    public static boolean isNetworkAvailable(Context context) {
        if (context == null && AppController.getGlobalContext() != null) {
            context = AppController.getGlobalContext();
        }
    ...
    public final void showToast(String toast) {
        if (toast != null) {
            Toast toast1 = Toast.makeText(AppController.getGlobalContext(), toast, Toast.LENGTH_LONG);
//            toast1.setGravity(Gravity.CENTER, 0, 0);
    ...
    public void copytoClipboard(String str) {
        try {
            if (str != null) {
                ClipboardManager clipboard = (ClipboardManager) AppController.getGlobalContext().getSystemService(Context.CLIPBOARD_SERVICE);
    ...
    float converDPtoPx(int dp) {
        Resources r = AppController.getGlobalContext().getResources();
    ...
    public void showSnakBarwithOk(View view, String message) {
        if (view != null && message != null) {
            ...
            snackbar.setActionTextColor(ContextCompat.getColor(AppController.getGlobalContext(), R.color.colorAccent));
