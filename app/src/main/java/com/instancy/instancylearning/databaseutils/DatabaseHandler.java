...
import com.instancy.instancylearning.mylearning.MyLearningScheduleGroupModel;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public static final String TBL_DOWNLOADDATA_REPORTS = "DOWNLOADDATAREPORTS";
    ...
    public static final String TBL_ASKSORT = "TBL_ASKSORT";
    /**
     * To store the discussion forum topic details
     */
    ...
    public static final String TBL_LOCALIZATION = "LOCALIZATION";

    public static final String TBL_DETAILS_SCHEDULE = "TBLDETAILSSCHEDULE";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS "
                + TBL_LOCALIZATION
                + "(ID INTEGER PRIMARY KEY AUTOINCREMENT, locale TEXT, languageName TEXT, status TEXT,description TEXT,siteId TEXT,languageID INT,countryflag TEXT)");
...
//                + "(contentid TEXT,forumid TEXT,name TEXT, createddate TEXT,createduserid TEXT,noofreplies TEXT,noofviews TEXT,siteid INTEGER, longdescription TEXT,uploadfilename TEXT, siteurl TEXT, PRIMARY KEY(siteurl,forumid,contentid))");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS " + TBL_ASKSORT + "(ID INTEGER PRIMARY KEY AUTOINCREMENT, siteID INTEGER, ComponentID INTEGER, LocalID TEXT, OptionText TEXT, OptionValue TEXT, sortID INTEGER,EnableColumn TEXT)");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS "
                + TBL_MYSKILLS
                + "(ID INTEGER PRIMARY KEY AUTOINCREMENT, siteid TEXT, userid TEXT, skillcountObj BLOB,skillname TEXT,skillcontentviewlink TEXT)");
    ...
    public void dropTableOnUpdating(SQLiteDatabase db, String TableToDrop) {
        db.execSQL("DROP TABLE IF EXISTS " + TableToDrop);
    }

    public void upgradeTables(SQLiteDatabase db) {

        dropTableOnUpdating(db, TBL_DOWNLOADDATA);
        dropTableOnUpdating(db, TBL_CMI);
        dropTableOnUpdating(db, TBL_TRACKLISTDATA);
...
//                            Log.d(TAG, "uisettingsJsonOjb: "+nativeSettingsObj);
                                    ...
                                    if (nativeSettingsObj.get("name").getAsString().equals("autodownloadsizelimit")) {
                                        ...
                                        uiSettingsModel.setMyLearningContentDownloadType(nativeSettingsObj.get("keyvalue").getAsString());
                                    ...
                                    } else if ((nativeSettingsObj.get("name").getAsString().equalsIgnoreCase("IsGlobasearch"))) {

                                        uiSettingsModel.setGlobasearch(nativeSettingsObj.get("keyvalue").getAsBoolean());
                                    ...
                                    } else if ((nativeSettingsObj.get("name").getAsString().equalsIgnoreCase("EnableMultipleInstancesforEvent"))) {

                                        uiSettingsModel.setEnableMultipleInstancesforEvent(nativeSettingsObj.get("keyvalue").getAsBoolean());
                                    } else if ((nativeSettingsObj.get("name").getAsString().equalsIgnoreCase("NumberOfRatingsRequiredToShowRating"))) {

                                        uiSettingsModel.setNumberOfRatingsRequiredToShowRating(nativeSettingsObj.get("keyvalue").getAsInt());
                                    } else if ((nativeSettingsObj.get("name").getAsString().equalsIgnoreCase("MinimimRatingRequiredToShowRating"))) {

                                        uiSettingsModel.setMinimimRatingRequiredToShowRating(nativeSettingsObj.get("keyvalue").getAsString());
                                    } else if ((nativeSettingsObj.get("name").getAsString().equalsIgnoreCase("NoOfDaysForCourseTargetDate"))) {

                                        uiSettingsModel.setNoOfDaysForCourseTargetDate(nativeSettingsObj.get("keyvalue").getAsInt());
                                    ...
                                    } else if ((nativeSettingsObj.get("name").getAsString().equalsIgnoreCase("ShowMembershipContentPricebyStrikeThrough"))) {

                                        uiSettingsModel.setPricebyStrikeThrough(nativeSettingsObj.get("keyvalue").getAsBoolean());
                                    } else if ((nativeSettingsObj.get("name").getAsString().equalsIgnoreCase("DiscussionForumFileTypes"))) {

                                        uiSettingsModel.setDiscussionForumFileTypes(nativeSettingsObj.get("keyvalue").getAsString());
                                    } else if ((nativeSettingsObj.get("name").getAsString().equalsIgnoreCase("UserUploadFileSize"))) {

                                        uiSettingsModel.setUserUploadFileSize(nativeSettingsObj.get("keyvalue").getAsString());
                                    }
                                }
                            }
                        }
                        ...
                        if (jsonObject.has("table5")) {
                            JsonArray jsonTableFive = jsonObject.get("table5").getAsJsonArray();

                            if (jsonTableFive.size() > 0) {
                                ejectRecordsinTable(TBL_LOCALIZATION);

                                for (int i = 0; i < jsonTableFive.size(); i++) {
                                    JsonObject localeObj = jsonTableFive.get(i).getAsJsonObject();
                                    LocalizationSelectionModel localizationSelectionModel = new LocalizationSelectionModel();

                                    if (localeObj.has("languagename")) {
                                        localizationSelectionModel.languageName = localeObj.get("languagename").toString().replace("\"", "");

                                    }
                                    if (localeObj.has("locale")) {
                                        localizationSelectionModel.locale = localeObj.get("locale").toString().replace("\"", "");

                                    }
                                    if (localeObj.has("description")) {
                                        localizationSelectionModel.languageDescription = localeObj.get("description").toString().replace("\"", "");

                                    }
                                    if (localeObj.has("status")) {
                                        localizationSelectionModel.status = localeObj.get("status").toString().replace("\"", "");

                                    }
                                    if (localeObj.has("id")) {
                                        localizationSelectionModel.languageID = localeObj.get("id").getAsInt();

                                    }
                                    if (localeObj.has("countryflag")) {
                                        localizationSelectionModel.countryFlag = localeObj.get("countryflag").toString().replace("\"", "");

                                    }

                                    localizationSelectionModel.siteId = appUserModel.getSiteIDValue();

                                    insertLocalization(localizationSelectionModel);
                                }
                            }
                        }
    ...
    public void insertIntoAppContentSettingsTable(UiSettingsModel uiSettingsModel, String siteid, String siteUrl) {
        ...
        try {
            ...
            contentValues.put("contentDownloadType", uiSettingsModel.getMyLearningContentDownloadType());
            ...
            contentValues.put("EnableMultipleInstancesforEvent", uiSettingsModel.isEnableMultipleInstancesforEvent());
            ...
            contentValues.put("NumberOfRatingsRequiredToShowRating", uiSettingsModel.getNumberOfRatingsRequiredToShowRating());
            ...
            contentValues.put("pricebyStrikeThrough", uiSettingsModel.isPricebyStrikeThrough());

            contentValues.put("UserUploadFileSize", uiSettingsModel.getUserUploadFileSize());

            contentValues.put("DiscussionForumFileTypes", uiSettingsModel.getDiscussionForumFileTypes());
    ...
    public void insertLocalization(LocalizationSelectionModel localizationSelectionModel) {
        ...
        try {
            ...
            contentValues.put("locale", localizationSelectionModel.locale);
            contentValues.put("languageName", localizationSelectionModel.languageName);
            contentValues.put("status", localizationSelectionModel.status);
            contentValues.put("description", localizationSelectionModel.languageDescription);
            contentValues.put("siteId", localizationSelectionModel.siteId);
            contentValues.put("languageID", localizationSelectionModel.languageID);
            contentValues.put("countryflag", localizationSelectionModel.countryFlag);

            db.insert(TBL_LOCALIZATION, null, contentValues);
        } catch (SQLiteException sqlEx) {
            sqlEx.printStackTrace();
    ...
    public List<LocalizationSelectionModel> fetchLocalizationList(String siteID) {
        List<LocalizationSelectionModel> localizationSelectionModelList = new ArrayList<LocalizationSelectionModel>();
        SQLiteDatabase db = this.getWritableDatabase();


        String strSelQuery = "SELECT * from " + TBL_LOCALIZATION + " where siteID =" + siteID;

        Log.d(TAG, "fetchLocalizationList: " + strSelQuery);
        try {
            Cursor cursor = null;
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                do {
                    ...
                    localizationSelectionModel.siteId = cursor.getString(cursor
                            .getColumnIndex("siteId"));

                    localizationSelectionModel.locale = cursor.getString(cursor
                            .getColumnIndex("locale"));

                    localizationSelectionModel.languageName = cursor.getString(cursor
                            .getColumnIndex("languageName"));

                    localizationSelectionModel.languageID = cursor.getInt(cursor
                            .getColumnIndex("languageID"));

                    localizationSelectionModel.languageDescription = cursor.getString(cursor
                            .getColumnIndex("description"));

                    localizationSelectionModel.countryFlag = cursor.getString(cursor
                            .getColumnIndex("countryflag"));

                    localizationSelectionModel.status = cursor.getString(cursor
                            .getColumnIndex("status"));


                    localizationSelectionModelList.add(localizationSelectionModel);
        ...
        return localizationSelectionModelList;
    }
    ...
    public UiSettingsModel getAppSettingsFromLocal(String siteUrl, String siteId) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            uiSettingsModel.setAppButtonBgColor(cursor.getString(cursor
                    .getColumnIndex("appButtonBGColor")));

            uiSettingsModel.setAppButtonTextColor(cursor.getString(cursor
                    .getColumnIndex("appButtonTextColor")));


            uiSettingsModel.setSelfRegistrationAllowed(cursor.getString(cursor
                    .getColumnIndex("selfRegistrationAllowed")));

            uiSettingsModel.setMyLearningContentDownloadType(cursor.getString(cursor
            ...
            uiSettingsModel.setNumberOfRatingsRequiredToShowRating(cursor.getInt(cursor
                    .getColumnIndex("NumberOfRatingsRequiredToShowRating")));

            uiSettingsModel.setMinimimRatingRequiredToShowRating(cursor.getString(cursor
                    .getColumnIndex("MinimimRatingRequiredToShowRating")));

            uiSettingsModel.setNoOfDaysForCourseTargetDate(cursor.getInt(cursor
                    .getColumnIndex("NoOfDaysForCourseTargetDate")));
            ...
            uiSettingsModel.setEnableEcommerce(cursor.getInt(cursor
                    .getColumnIndex("pricebyStrikeThrough")) > 0);

            uiSettingsModel.setUserUploadFileSize(cursor.getString(cursor
                    .getColumnIndex("UserUploadFileSize")));

            uiSettingsModel.setDiscussionForumFileTypes(cursor.getString(cursor
                    .getColumnIndex("DiscussionForumFileTypes")));
    ...
    public void getNativeMenusFromServer(String webApiUrl, String siteUrl) {
        String paramsString = "SiteURL=" + siteUrl + "&Locale=" + preferencesManager.getLocalizationStringValue("locale_name");
...
//            if (result.length() > 0) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonTable.size(); i++) {
                        ...
                        if (nativeMenuJsonObj.has("webmenuid")) {

                            JsonElement el = nativeMenuJsonObj.get("webmenuid");

                            if (el != null && !el.isJsonNull()) {

                                nativeMenuModel.setWebMenuId(nativeMenuJsonObj.get("webmenuid").getAsInt());
                        ...
                        // Uncomment for progress report
//                        if (nativeMenuModel.getContextmenuId().equalsIgnoreCase("14")) {
//
//                            continue;
//                        }
    ...
    public List<SideMenusModel> getNativeMainMenusData(boolean isAzureEnabled, Context context, String signOutLabel) {
...
//            menu.setDisplayName(context.getResources().getString(R.string.side_menu_signout));
            menu.setDisplayName(signOutLabel);
        ...
        try {
            ...
            if (cursor != null) {
                while (cursor.moveToNext()) {
                    ...
                    sideMenusModel.setMenuId(cursor.getInt(cursor
                            .getColumnIndex("menuid")));
                    sideMenusModel.setDisplayName(cursor.getString(cursor
                            .getColumnIndex("displayname")));
                    sideMenusModel.setDisplayOrder(cursor.getInt(cursor
                            .getColumnIndex("displayorder")));
...
//                    sideMenusModel.setMenuImageResId(menuIconResId);
                    ...
                    sideMenusModel.setIsEnabled(cursor.getString(cursor
                            .getColumnIndex("isenabled")));
                    sideMenusModel.setContextTitle(cursor.getString(cursor
                            .getColumnIndex("contexttitle")));
                    sideMenusModel.setContextMenuId(cursor.getString(cursor
                            .getColumnIndex("contextmenuid")));
                    sideMenusModel.setRepositoryId(cursor.getString(cursor
                            .getColumnIndex("repositoryid")));
                    sideMenusModel.setLandingPageType(cursor.getString(cursor
                            .getColumnIndex("landingpagetype")));
                    sideMenusModel.setCategoryStyle(cursor.getString(cursor
                            .getColumnIndex("categorystyle")));
                    sideMenusModel.setComponentId(cursor.getString(cursor
                            .getColumnIndex("componentid")));
                    sideMenusModel.setConditions(cursor.getString(cursor
                            .getColumnIndex("conditions")));
                    sideMenusModel.setParentMenuId(cursor.getString(cursor
                            .getColumnIndex("parentmenuid")));
...
//                    + appUserModel.getSiteIDValue() + " AND siteurl = '" + appUserModel.getSiteURL() + "' AND eventTabValue = '" + TabValue + "'";
    ...
    public void insertIntoNativeMenusTable(NativeMenuModel nativeMenuModel, String siteid, String siteUrl) {
        ...
        try {
            ...
            contentValues.put("webmenuid", nativeMenuModel.getWebMenuId());
...
//            }
            ...
            if (jsonMyLearningColumnObj.has("isarchived")) {
                ...
                myLearningModel.setArchived(jsonMyLearningColumnObj.optBoolean("isarchived"));
...
//            contentValues.put("eventid", myLearningModel.getEventContentid());
            ...
            contentValues.put("isRequired", myLearningModel.getIsRequired());
            ...
            contentValues.put("reSheduleEvent", myLearningModel.getReSheduleEvent());
            contentValues.put("removeFromMylearning", myLearningModel.isRemoveFromMylearning());

            contentValues.put("isBadCancellationEnabled", myLearningModel.isBadCancellationEnabled());
            contentValues.put("isEnrollFutureInstance", myLearningModel.isEnrollFutureInstance());

            contentValues.put("percentcompleted", myLearningModel.getPercentCompleted());

            contentValues.put("certificateaction", myLearningModel.getCertificateAction());

            contentValues.put("certificateid", myLearningModel.getCertificateId());

            contentValues.put("certificatepage", myLearningModel.getCertificatePage());
...
//                        + myLearningModel.getScoId() + "'", null);
                ...
                db.delete(TBL_DOWNLOADDATA_REPORTS, "siteid='" + myLearningModel.getSiteID()
                        + "' AND userid='" + myLearningModel.getUserID() + "' AND scoid='"
                        + myLearningModel.getScoId() + "'", null);
...
//                        + "' AND userid='" + myLearningModel.getUserID() + "' AND scoid='"
//                        + myLearningModel.getScoId() + "'", null);
                db.insert(TBL_DOWNLOADDATA_REPORTS, null, contentValues);
            }
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                do {
                    ...
                    myLearningModel.setIsRequired(cursor.getInt(cursor
                            .getColumnIndex("isRequired")));

                    myLearningModel.setTotalratings(cursor.getInt(cursor
                            .getColumnIndex("totalratings")));
                    ...
                    myLearningModel.setRemoveFromMylearning(cursor.getInt(cursor
                            .getColumnIndex("removeFromMylearning")) > 0);

                    myLearningModel.setReSheduleEvent(cursor.getString(cursor
                            .getColumnIndex("reSheduleEvent")));
                    ...
                    myLearningModel.setEnrollFutureInstance(cursor.getInt(cursor
                            .getColumnIndex("isEnrollFutureInstance")) > 0);

                    myLearningModel.setPercentCompleted(cursor.getString(cursor
                            .getColumnIndex("percentcompleted")));

                    myLearningModel.setCertificateAction(cursor.getString(cursor
                            .getColumnIndex("certificateaction")));

                    myLearningModel.setCertificateId(cursor.getString(cursor
                            .getColumnIndex("certificateid")));

                    myLearningModel.setCertificatePage(cursor.getString(cursor
                            .getColumnIndex("certificatepage")));
...
//                availableseats
                ...
                myLearningModel.setActionWaitlist(jsonMyLearningColumnObj.optString("actionwaitlist", ""));
            ...
            if (!orderType.equalsIgnoreCase("publisheddate")) {
                ...
                switch (typeTab) {
                    ...
                    case "calendar":
                        ...
                        break;
                    case "myevents":
                        strSelQuery = "SELECT DISTINCT * FROM " + TBL_EVENTCONTENTDATA + " WHERE categorycompid = " + componentID + " AND eventendUtctime !=''" + " AND eventTabValue ='" + typeTab + "' ORDER BY eventstarttime ASC";
                        break;
                }
...
//        }
    ...
    public void injectTracklistData(Boolean isTrackList, JSONObject jsonObject, MyLearningModel parentModel) throws JSONException {
        ...
        JSONArray jsonBookMarkAry = null;

        if (isTrackList) {
            jsonTableAry = jsonObject.getJSONArray("table5");
            jsonTableBlocks = jsonObject.getJSONArray("table6");
            if (jsonObject.has("table7")) {
                jsonBookMarkAry = jsonObject.getJSONArray("table7");
            }
...
//            jsonTableBlocks = jsonObject.getJSONArray("table6");
        ...
        for (int i = 0; i < jsonTableAry.length(); i++) {
            ...
            if (isTrackList && jsonBookMarkAry != null) {
                JSONObject jsonObject1 = jsonBookMarkAry.getJSONObject(0);

                if (jsonObject1.has("bookmarkid")) {
                    trackLearningModel.setBookmarkID(jsonObject1.optInt("bookmarkid", 0));
                }
            }
...
//                    String imagePathSet = trackLearningModel.getSiteURL() + "/content/sitefiles/Images/" + trackLearningModel.getContentID() + "/" + imageurl;
                    trackLearningModel.setImageData(imageurl);
...
//                    }
                    if (!isValidString(trackLearningModel.getStatusActual()) || !isValidString(trackLearningModel.getStatusDisplay())) {
                        trackLearningModel.setStatusActual("not started");
                    }
                ...
                // medianame
                if (jsonMyLearningColumnObj.has("medianame")) {
                    String medianame = jsonMyLearningColumnObj.getString("medianame");
...
//                    }
                ...
                if (jsonMyLearningColumnObj.has("contenttype")) {
                    trackLearningModel.setMediaName(jsonMyLearningColumnObj.get("contenttype").toString());
                }
...
//            }
    ...
    public void injectIntoTrackObjectsTable(TrackObjectsModel trackObjModel) {
        ...
        try {
            ...
            contentValues.put("mediatypeid", trackObjModel.getMediaTypeId());
    ...
    public void injectIntoTrackTable(MyLearningModel trackListModel) {
        ...
        try {
            ...
            contentValues.put("bookmarkid", trackListModel.getBookmarkID());
...
// for tracklis
                    ...
                    if (isTrackListView) {
                        ...
                        trackListModel.setBookmarkID(cursor.getInt(cursor
                                .getColumnIndex("bookmarkid")));
    ...
    public int updateContentStatus(MyLearningModel myLearningModel, String updatedStatus, String progress, String localeStatus) {
        SQLiteDatabase db = this.getWritableDatabase();
        int status = -1;
        ...
        try {
            ...
            String strUpdate = "UPDATE " + TBL_DOWNLOADDATA + " SET status = '"
                    + updatedStatus + "', displaystatus = '" + localeStatus
    ...
    public int updateContentStatusFromLRSInterface(MyLearningModel myLearningModel, String percantageCompleted) {
        SQLiteDatabase db = this.getWritableDatabase();
        int status = -1;

        try {

            String strUpdate = "UPDATE " + TBL_DOWNLOADDATA + " SET percentcompleted = '"
                    + percantageCompleted + "', progress = '" + percantageCompleted
                    + "' WHERE siteid ='"
                    + myLearningModel.getSiteID() + "'"
                    + " AND " + " scoid=" + "'"
                    + myLearningModel.getScoId() + "'" + " AND "
    ...
    public int updateContentStatusInTrackList(MyLearningModel myLearningModel, String updatedStatus, String progress, boolean isEventList, String localeStatus) {
        SQLiteDatabase db = this.getWritableDatabase();
        int status = -1;
        ...
        try {
            ...
            String strUpdate = "UPDATE " + TBL_TYPE + " SET status = '"
                    + updatedStatus + "', progress = '" + progress + "', displaystatus = '" + localeStatus
                    + "' WHERE siteid ='"
                    + myLearningModel.getSiteID() + "'"
                    + " AND " + " scoid=" + "'"
                    + myLearningModel.getScoId() + "'" + " AND "
        ...
        try {
            ...
            if (updatedStatus.toLowerCase().contains("failed")) {
                ...
                String strUpdate = "UPDATE " + TBL_CMI + " SET status = '" + updatedStatus
                        + "' WHERE siteid ='"
                        + myLearningModel.getSiteID() + "'"
                        + " AND " + " scoid=" + "'"
                        + myLearningModel.getScoId() + "'" + " AND "
    ...
    public int updateContentStatusInTrackListLRS(MyLearningModel myLearningModel, String updatedStatus, boolean isEventList) {
        SQLiteDatabase db = this.getWritableDatabase();
        int status = -1;
        String TBL_TYPE = "TRACKLISTDATA";
        ...
        try {
            ...
            String strUpdate = "UPDATE " + TBL_TYPE + " SET  progress = '" + updatedStatus
                    + "' WHERE siteid ='"
                    + myLearningModel.getSiteID() + "'"
                    + " AND " + " scoid=" + "'"
                    + myLearningModel.getScoId() + "'" + " AND "
...
//            if (progressValue.equalsIgnoreCase("100.00")){
//
//            }

            String strExeQuery = "";
            if (isRecordExists) {
                strExeQuery = "UPDATE CMI SET percentageCompleted = '" + progressValue + "'"
                        + ", isupdate= 'false'" + " WHERE scoid="
                        + cmiNew.getScoId() + " AND siteid=" + cmiNew.getSiteID()
                        + " AND userid=" + cmiNew.getUserID();
                ...
                strExeQuery = "INSERT INTO "
                        + TBL_CMI
                        + "(siteid,scoid,userid,location,status,suspenddata,objecttypeid,datecompleted,noofattempts,percentageCompleted,sequencenumber,isupdate,startdate,timespent,coursemode,scoremin,scoremax,randomquesseq,siteurl,textResponses)"
                        + " VALUES (" + cmiNew.getSiteID() + ","
                        + cmiNew.getScoId() + "," + cmiNew.getUserID()
                        + ",'" + "" + "','"
                        + "incomplete" + "','"
                        + "" + "','"
                        + cmiNew.getObjecttypeId() + "','"
                        + "" + "',"
                        + "1" + ",'"
                        + progressValue + "','" + cmiNew.getSequenceNumber()
                        + "','" + "false" + "','"
                        + cmiNew.getStartDate() + "','"
                        + "" + "','"
                        + "" + "','"
    ...
    public boolean isCMIRecordExists(MyLearningModel learningModel) {
        boolean isRecordExists = false;
        try {
            SQLiteDatabase db = this.getWritableDatabase();
            Cursor cursor = null;
            String strExeQuery = "SELECT * FROM " + TBL_CMI + " WHERE siteid= "
                    + learningModel.getSiteID()
                    + " AND userid= "
                    + learningModel.getUserID()
                    + " AND scoid = '"
...
//    }
    ...
    public List<CMIModel> getAllCmiRelatedContentDetails() {
        ...
        String selQuery = "SELECT C.location, C.status, C.suspenddata,C.percentageCompleted, C.datecompleted, C.noofattempts, C.score, D.objecttypeid, C.sequencenumber, C.scoid, C.userid, C.siteid, D.courseattempts, D.contentid, D.trackcontentid, D.trackscoid, C.coursemode, C.scoremin, C.scoreMax, C.randomQuesSeq, C.textResponses, C.ID, C.siteurl,C.pooledquesseq FROM "
                + TBL_CMI
                + " C inner join "
                + TBL_RELATEDCONTENTDATA
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                cmiDetails.setPercentageCompleted(cursor.getString(cursor
                        .getColumnIndex("percentageCompleted")));
    ...
    public List<CMIModel> getAllCmiTrackListDetails() {
        ...
        String selQuery = "SELECT C.location, C.status, C.suspenddata, C.datecompleted, C.noofattempts, C.score,C.sequencenumber,C.percentageCompleted, C.scoid, C.userid, C.siteid, D.courseattempts, D.objecttypeid, D.contentid, D.trackContentId, D.trackscoid, C.coursemode, C.scoremin, C.scoreMax, C.randomQuesSeq, C.textResponses, C.ID, C.siteurl, C.pooledquesseq FROM "
                + TBL_CMI
                + " C inner join "
                + TBL_TRACKLISTDATA
                + " D On D.userid = C.userid and D.scoid = C.scoid and D.siteid = C.siteid WHERE C.isupdate = 'false' ORDER BY C.sequencenumber ";
...
//                        .getColumnIndex("attemptnumber")));
    ...
    public List<CMIModel> getAllCmiDownloadDataDetails() {
        ...
        String selQuery = "SELECT C.location, C.status, C.suspenddata, C.datecompleted, C.noofattempts, C.score,C.percentageCompleted, D.objecttypeid, C.sequencenumber, C.scoid, C.userid, C.siteid, D.courseattempts, D.contentid, C.coursemode, C.scoremin, C.scoreMax, C.randomQuesSeq, C.textResponses, C.ID, C.siteurl, C.pooledquesseq FROM "
                + TBL_CMI
                + " C inner join "
                + TBL_DOWNLOADDATA
                + " D On D.userid = C.userid and D.scoid = C.scoid and D.siteid = C.siteid WHERE C.isupdate = 'false' ORDER BY C.sequencenumber";
...
//    }
    ...
    public void updateCMIstatus(MyLearningModel learningmodel, String updatedStatus, int progressValue) {
...
//                    myLearningModel.setMemberShipLevel(jsonMyLearningColumnObj.getInt("membershiplevel"));
                ...
                injectMyLearningIntoTable(myLearningModel, true, false);
...
//                    if (dataFieldName.toLowerCase().equalsIgnoreCase(fieldName)) {
    ...
    public List<SignUpConfigsModel> fetchUserSignConfigs(Context context, String confirmPassword) {
...
//                    signUpConfigsModel.names = (cursor.getString(cursor.getColumnIndex("name")));
                    ...
                    if (signUpConfigsModel.attributeconfigid.equalsIgnoreCase("6") && signUpConfigsModel.uicontroltypeid.equalsIgnoreCase("4")) {
                        ...
                        confirmPasswordModel.displaytext = confirmPassword;
//                        getLocalizationValue(JsonLocalekeys.network_alerttitle_nointernet)
...
//                    + " UPC ON UPG.groupid= UPC.groupid WHERE UPC.enduservisibility='true' ORDER BY UPC.displayorder";
            strSelQuery = "SELECT DISTINCT UPC.*,UPG.groupid FROM "
                    ...
                    + " UPG LEFT OUTER JOIN "
                    + TBL_USERPROFILECONFIGS
                    + " UPC ON UPG.groupid= UPC.groupid ORDER BY UPC.displayorder";
...
//                    + "' AND UPC.enduservisibility='true' ORDER BY UPC.displayorder";
    ...
    public List<CatalogCategoryButtonModel> getCatalogCategoryDetails(
        ...
        try {
            ...
            Log.d("getCatalogCategory", e.getMessage());
...
//            }
            ...
            if (jsonMyLearningColumnObj.has("AskTheQuestion")) {

                peopleListingModel.askaQuestion = jsonMyLearningColumnObj.getString("AskTheQuestion");
    ...
    public void injectPeopleDataIntoTable(PeopleListingModel peopleListingModel) {
        ...
        try {
            ...
            contentValues.put("askaquestion", peopleListingModel.askaQuestion);
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                do {
                    ...
                    peopleListingModel.askaQuestion = cursor.getString(cursor
                            .getColumnIndex("askaquestion"));
...
//                        trackObjectsModel.setTrackSoId(jsonTrackObj.getString("trackscoid"));
                    ...
                    trackObjectsModel.setMediaTypeId(jsonTrackObj.optString("mediatypeid", ""));
...
//                ejectRecordsinTrackObjDb(learningModel);
    ...
    public ReportDetail getReportForContent(MyLearningModel learningModel, boolean isRelatedContent, String typeFrom, boolean isProgressReport) {
...
//        }
        ...
        if (pageTypeContent.equalsIgnoreCase("event")) {
            ...
            if (isProgressReport) {
                strSelQuerys = "SELECT distinct C.datecompleted, C.startdate, D.objecttypeid, C.timespent, C.score, D.coursename, D.islistview, case when C.status is NOT NULL then C.status else D.status end as ObjStatus  FROM " + TBL_DOWNLOADDATA_REPORTS + " D left outer join " + TBL_CMI + " C On D.userid=C.userid and D.scoid =C.scoid where D.userid = " + learningModel.getUserID() + " AND D.scoid = " + learningModel.getScoId() + " AND D.siteid =  " + learningModel.getSiteID();
            }
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                do {
                    ...
                    reportDetail.mediaTypeId = cursor.getString(cursor
                            .getColumnIndex("mediatypeid"));
...
//         = jsonObject.getJSONArray("UserLevel");
        ...
        jsonUserBadgesAry = jsonObject.optJSONArray("UserBadges");
...
//        showlevelsection = jsonObject.optString("showLevelSection","false");
//        showpointsection = jsonObject.optString("showPointSection","false");
//        showbadgesection = jsonObject.optString("showBadgeSection","false");
        ...
        if (jsonUserPointsAry != null && jsonUserPointsAry.length() > 0) {
            ...
            int restrictedSize = jsonUserPointsAry.length() >= 5 ? 5 : jsonUserPointsAry.length();
...
//UserLevelAry
        ...
        if (jsonUserLevelAry != null && jsonUserLevelAry.length() > 0) {
            int restrictedSize = jsonUserLevelAry.length() >= 5 ? 5 : jsonUserLevelAry.length();
            for (int i = 0; i < restrictedSize; i++) {
...
//                    String formattedDate = formatDate(profilePrivObj.getString("LevelRecivedDate"), "yyyy-MM-dd'T'HH:mm:ss", "MMM dd, yyyy");
                    ...
                    String formattedDate = profilePrivObj.getString("LevelRecivedDate");
...
// UserBadges Ary
        ...
        if (jsonUserBadgesAry != null && jsonUserBadgesAry.length() > 0) {
            int restrictedSize = jsonUserBadgesAry.length() >= 5 ? 5 : jsonUserBadgesAry.length();
            for (int i = 0; i < restrictedSize; i++) {
...
//        }
//    }
    public void injectDetailsScheduleDataIntoTable(MyLearningScheduleChildModel myLearningScheduleChildModel) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = null;
        try {
            contentValues = new ContentValues();
            contentValues.put("EventID", myLearningScheduleChildModel.getEventID());
            contentValues.put("ContentID", myLearningScheduleChildModel.getContentID());
            contentValues.put("Name", myLearningScheduleChildModel.getName());
            contentValues.put("Duration", myLearningScheduleChildModel.getDuration());
            contentValues.put("EventStartDateTime", myLearningScheduleChildModel.getEventStartDateTime());
            contentValues.put("EventEndDateTime", myLearningScheduleChildModel.getEventEndDateTime());
            contentValues.put("Location", myLearningScheduleChildModel.getLocation());
            contentValues.put("TimeZone", myLearningScheduleChildModel.getTimeZone());
            contentValues.put("PresenterID", myLearningScheduleChildModel.getPresenterID());
            contentValues.put("Email", myLearningScheduleChildModel.getEmail());
            contentValues.put("AccountType", myLearningScheduleChildModel.getAccountType());
            contentValues.put("Picture", myLearningScheduleChildModel.getPicture());
            contentValues.put("DisplayName", myLearningScheduleChildModel.getDisplayName());
            contentValues.put("About", myLearningScheduleChildModel.getAbout());
            contentValues.put("Bit4", myLearningScheduleChildModel.getBit4());
            contentValues.put("AuthorName", myLearningScheduleChildModel.getAuthorName());
            contentValues.put("EnrollmentLimit", myLearningScheduleChildModel.getEnrollmentLimit());
            contentValues.put("AvailableSeats", myLearningScheduleChildModel.getAvailableSeats());
            contentValues.put("TotalEnrolls", myLearningScheduleChildModel.getTotalEnrolls());
            contentValues.put("WaitListEnrolls", myLearningScheduleChildModel.getWaitListEnrolls());
            contentValues.put("WaitListLimit", myLearningScheduleChildModel.getWaitListLimit());
            contentValues.put("LocationImage", myLearningScheduleChildModel.getLocationImage());
            contentValues.put("alreadyexist", myLearningScheduleChildModel.getAlreadyExist());
            contentValues.put("showenroll", myLearningScheduleChildModel.getShowenroll());
            contentValues.put("showwaitlis", myLearningScheduleChildModel.getShowwaitlist());

            String strSelQuery = "SELECT * from " + TBL_DETAILS_SCHEDULE + " WHERE" +
                    " ContentID= '"
                    + myLearningScheduleChildModel.getContentID() + "'";
            Cursor cursor = null;
            cursor = db.rawQuery(strSelQuery, null);
            if (cursor != null && cursor.getCount() > 0) {
                db.update(TBL_DETAILS_SCHEDULE, contentValues, "ContentID ='" + myLearningScheduleChildModel.getContentID() + "'", null);
            } else {
                db.insert(TBL_DETAILS_SCHEDULE, null, contentValues);
            }
    ...
    public ArrayList<MyLearningScheduleGroupModel> fetchDetailsScheduleData(ArrayList<MyLearningScheduleGroupModel> myLearningScheduleGroupModelList, String eventID) {


        SQLiteDatabase db = this.getWritableDatabase();
        String strSelQuery = "SELECT * from " + TBL_DETAILS_SCHEDULE + " WHERE EventID ='" + eventID + "'";
        ...
        try {
            ...
            if (cursor != null) {
                while (cursor.moveToNext()) {
                    ...
                    MyLearningScheduleGroupModel learningScheduleGroupModel = new MyLearningScheduleGroupModel();
                    learningScheduleGroupModel.setEventID(cursor.getString(cursor.getColumnIndex("EventID")));
                    learningScheduleGroupModel.setContentID(cursor.getString(cursor.getColumnIndex("ContentID")));
                    learningScheduleGroupModel.setName(cursor.getString(cursor.getColumnIndex("Name")));
                    learningScheduleGroupModel.setDuration(cursor.getString(cursor.getColumnIndex("Duration")));
                    learningScheduleGroupModel.setEventStartDateTime(cursor.getString(cursor.getColumnIndex("EventStartDateTime")));
                    learningScheduleGroupModel.setEventEndDateTime(cursor.getString(cursor.getColumnIndex("EventEndDateTime")));
                    learningScheduleGroupModel.setLocation(cursor.getString(cursor.getColumnIndex("Location")));
                    learningScheduleGroupModel.setTimeZone(cursor.getString(cursor.getColumnIndex("TimeZone")));
                    learningScheduleGroupModel.setPresenterID(cursor.getString(cursor.getColumnIndex("PresenterID")));
                    learningScheduleGroupModel.setEmail(cursor.getString(cursor.getColumnIndex("Email")));
                    learningScheduleGroupModel.setAccountType(cursor.getString(cursor.getColumnIndex("AccountType")));
                    learningScheduleGroupModel.setPicture(cursor.getString(cursor.getColumnIndex("Picture")));
                    learningScheduleGroupModel.setDisplayName(cursor.getString(cursor.getColumnIndex("DisplayName")));
                    learningScheduleGroupModel.setAbout(cursor.getString(cursor.getColumnIndex("About")));
                    learningScheduleGroupModel.setBit4(cursor.getString(cursor.getColumnIndex("Bit4")));
                    learningScheduleGroupModel.setAuthorName(cursor.getString(cursor.getColumnIndex("AuthorName")));
                    learningScheduleGroupModel.setEnrollmentLimit(cursor.getString(cursor.getColumnIndex("EnrollmentLimit")));
                    learningScheduleGroupModel.setAvailableSeats(cursor.getString(cursor.getColumnIndex("AvailableSeats")));
                    learningScheduleGroupModel.setTotalEnrolls(cursor.getString(cursor.getColumnIndex("TotalEnrolls")));
                    learningScheduleGroupModel.setWaitListEnrolls(cursor.getString(cursor.getColumnIndex("WaitListEnrolls")));
                    learningScheduleGroupModel.setLocationImage(cursor.getString(cursor.getColumnIndex("LocationImage")));


                    ArrayList<MyLearningScheduleChildModel> myLearningScheduleChildModelArrayList = new ArrayList<>();

                    MyLearningScheduleChildModel learningScheduleChildModel = new MyLearningScheduleChildModel();

                    learningScheduleChildModel.setEventID(cursor.getString(cursor.getColumnIndex("EventID")).replace("_", "-"));
                    learningScheduleChildModel.setContentID(cursor.getString(cursor.getColumnIndex("ContentID")).replace("_", "-"));
                    learningScheduleChildModel.setName(cursor.getString(cursor.getColumnIndex("Name")));
                    learningScheduleChildModel.setDuration(cursor.getString(cursor.getColumnIndex("Duration")));
                    learningScheduleChildModel.setEventStartDateTime(cursor.getString(cursor.getColumnIndex("EventStartDateTime")));
                    learningScheduleChildModel.setEventEndDateTime(cursor.getString(cursor.getColumnIndex("EventEndDateTime")));
                    learningScheduleChildModel.setLocation(cursor.getString(cursor.getColumnIndex("Location")));
                    learningScheduleChildModel.setTimeZone(cursor.getString(cursor.getColumnIndex("TimeZone")));
                    learningScheduleChildModel.setPresenterID(cursor.getString(cursor.getColumnIndex("PresenterID")));
                    learningScheduleChildModel.setEmail(cursor.getString(cursor.getColumnIndex("Email")));
                    learningScheduleChildModel.setAccountType(cursor.getString(cursor.getColumnIndex("AccountType")));
                    learningScheduleChildModel.setPicture(cursor.getString(cursor.getColumnIndex("Picture")));
                    learningScheduleChildModel.setDisplayName(cursor.getString(cursor.getColumnIndex("DisplayName")));
                    learningScheduleChildModel.setAbout(cursor.getString(cursor.getColumnIndex("About")));
                    learningScheduleChildModel.setBit4(cursor.getString(cursor.getColumnIndex("Bit4")));
                    learningScheduleChildModel.setAuthorName(cursor.getString(cursor.getColumnIndex("AuthorName")));
                    learningScheduleChildModel.setEnrollmentLimit(cursor.getString(cursor.getColumnIndex("EnrollmentLimit")));
                    learningScheduleChildModel.setAvailableSeats(cursor.getString(cursor.getColumnIndex("AvailableSeats")));
                    learningScheduleChildModel.setTotalEnrolls(cursor.getString(cursor.getColumnIndex("TotalEnrolls")));
                    learningScheduleChildModel.setWaitListEnrolls(cursor.getString(cursor.getColumnIndex("WaitListEnrolls")));
                    learningScheduleChildModel.setLocationImage(cursor.getString(cursor.getColumnIndex("LocationImage")));

                    learningScheduleChildModel.setShowenroll(cursor.getString(cursor.getColumnIndex("showenroll")));
                    learningScheduleChildModel.setShowwaitlist(cursor.getString(cursor.getColumnIndex("showwaitlist")));

                    learningScheduleChildModel.setWaitListLimit(cursor.getString(cursor.getColumnIndex("WaitListLimit")));

                    //  learningScheduleChildModel.setAlreadyExist(cursor.getInt(cursor.getColumnIndex("alreadyexist")));

                    myLearningScheduleChildModelArrayList.add(learningScheduleChildModel);
                    learningScheduleGroupModel.setMyLearningScheduleChildModelArrayList(myLearningScheduleChildModelArrayList);

                    myLearningScheduleGroupModelList.add(learningScheduleGroupModel);
                }
            }
            cursor.close();
            db.close();
        ...
        return myLearningScheduleGroupModelList;
    }
