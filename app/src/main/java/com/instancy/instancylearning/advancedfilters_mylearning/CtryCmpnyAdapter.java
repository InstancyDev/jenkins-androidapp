...
public class CtryCmpnyAdapter extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<CtryCmpnyModel> ctryCmpnyModelList = null;
    ...
    public CtryCmpnyAdapter(Activity activity, List<CtryCmpnyModel> ctryCmpnyModelList, boolean isFromFinal) {
        this.activity = activity;
        this.ctryCmpnyModelList = ctryCmpnyModelList;
    ...
    public void refreshList(List<CtryCmpnyModel> ctryCmpnyModelList) {
        this.ctryCmpnyModelList = ctryCmpnyModelList;
        this.ctryCmpnyModelList = new ArrayList<CtryCmpnyModel>();
        this.ctryCmpnyModelList.addAll(ctryCmpnyModelList);
        this.notifyDataSetChanged();
    }

    @Override
    public int getCount() {
        return ctryCmpnyModelList.size();
    }

    @Override
    public Object getItem(int position) {
        return ctryCmpnyModelList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        CtryCmpnyModel filterByModel = ctryCmpnyModelList.get(position);
        ViewHolder holder;
